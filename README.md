...
<p align="center">
<b>AISW 계열 1학년</b>으로 재학 중이며,ㅎㅎ




세상을 편리하게 만드는 <b>웹 개발자</b>를 꿈꾸며 매일 성장하고 있습니다.ㅎㅎㅇ




기초부터 꾸준히 기록하고 배우는 것을 좋아합니다.g
</p>ㅇ
</p>
...
저의 목표는 탄탄한 소프트웨어 개발 역량을 바탕으로, 실생활에 유용한 가치를 창출하는 인공지능 엔지니어로 성장하는 것입니다. 이를 위해 우선 자료구조와 알고리즘, 운영체제 등 컴퓨터 공학의 핵심 기초를 깊이 있게 학습하여 흔들리지 않는 개발 기본기를 다지겠습니다.

이후 파이썬과 데이터 분석 라이브러리를 능숙하게 다루며 머신러닝과 딥러닝의 원리를 체계적으로 이해해 나갈 계획입니다. 단순히 이론 학습에 그치지 않고, 학습된 AI 모델을 실제 웹이나 앱 서비스에 적용해보는 융합 프로젝트를 통해 실무 감각을 익히겠습니다.

기술은 빠르게 변하기 때문에 최신 논문과 트렌드를 꾸준히 탐독하는 습관을 들이고, 기술적 우수함뿐만 아니라 AI 윤리까지 고민하는 책임감 있는 개발자가 되겠습니다. 궁극적으로는 사람들의 문제를 기술로 해결하는 대체 불가능한 전문가가 되고 싶습니다.
